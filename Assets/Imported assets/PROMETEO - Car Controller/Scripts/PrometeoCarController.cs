...
public class PrometeoCarController : MonoBehaviour
{
	...
	*/
	...
	private CarControllerEvents carControllerEvents;

	// Start is called before the first frame update
	void Start()
	{
		carControllerEvents = GetComponent<CarControllerEvents>();
		...
		*/
		...
		else
		{
			...
			if (Input.GetKey(KeyCode.W))
			{
				...
				CarControllerEvents.OnGoForward();
			}
			...
			if (Input.GetKey(KeyCode.Space))
			{
				...
				CarControllerEvents.OnUseHandbrake();
			}
			...
			if ((!Input.GetKey(KeyCode.S) && !Input.GetKey(KeyCode.W)))
			{
				...
				CarControllerEvents.OnThrottleOff();
			}
	...
	public void GoReverse()
	{
		...
		else
		{
			...
			CarControllerEvents.OnGoBackward();
		}
	}
